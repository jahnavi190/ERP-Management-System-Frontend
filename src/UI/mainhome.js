  ...
  return (
    <div>
      ...
      >
        ...
        >
          Welcome to KL university – Where Dreams Take Flight!
        </Typography>
        <Paper
        elevation={3}
        style={{
      ...
      >
          {showWelcome && (
            ...
            >
              At KL university, we believe in nurturing young minds to soar to new heights. Our commitment lies in fostering a learning environment where every student's potential is unlocked and their dreams take flight. With a rich tapestry of knowledge, innovation, and compassion, we shape the leaders of tomorrow.
            </Typography>
          )}
          {showDescription && (
            <>
              ...
              >
                At KL university, excellence is not just a goal; it's our way of life. Our dedicated faculty, passionate staff, and supportive community work hand-in-hand to create an environment where every student can excel. Together, we celebrate diversity, cultivate talent, and build lifelong connections.
              </Typography>
              <Typography
                variant="body1"
                style={{
